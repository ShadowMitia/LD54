...
export function wasm_bindgen__convert__closures__invoke0_mut__h636de541745f1c4f(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h24c390a21a24e2ed(a: number, b: number, c: number): void;
